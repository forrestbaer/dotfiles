...
export PATH=/usr/local/bin:/usr/local/sbin:~/avr32-tools/bin:~/Library/Python/3.9/lib/python/site-packages:~/Library/Python/3.9/bin:~/.local/bin:~/bin:/usr/bin:/bin:~/faust/bin:$PATH
